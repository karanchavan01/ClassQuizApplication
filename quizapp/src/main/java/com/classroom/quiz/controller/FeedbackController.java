...
public class FeedbackController {
	...
	@DeleteMapping("/{fid}")
	public void delete(@PathVariable Long fid) {
	...
	@GetMapping("/{fid}")
	public Feedback getFeedback(@PathVariable Long fid) {
		return this.feedbackService.getFeedback(fid);
	}
	
	@GetMapping("/user/{username}")
	public List<Feedback> getFeedbackByUsername(@PathVariable String username){
