...
import com.classroom.quiz.repository.UserImageRepository;
import com.classroom.quiz.service.UserService;
import com.classroom.quiz.service.impl.EmailServiceImpl;
...
public class UserController {
	...
	@PostMapping("/upload")
	public BodyBuilder uplaodImage(@RequestParam("imageFile") MultipartFile file, @RequestParam Long user_id)
			throws IOException {
	...
	@PutMapping("/upload-u")
	public BodyBuilder updateImage(@RequestParam("imageFile") MultipartFile file, @RequestParam Long user_id,
